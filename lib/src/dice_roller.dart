...
class DefaultDiceRoller extends DiceRoller {
  ...
  DefaultDiceRoller([Random? r]) : _random = r ?? Random.secure();
  ...
  Future<RollResult> roll(int ndice, int nsides, [String msg = '']) async {
    RangeError.checkValueInInterval(ndice, DiceRoller.minDice, DiceRoller.maxDice, 'ndice');
    RangeError.checkValueInInterval(nsides, DiceRoller.minSides, DiceRoller.maxSides, 'nsides');
    final results = [
